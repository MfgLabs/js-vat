...
/**
 * Check that a country code and a vat number are valids together
 */
function checkVATForGivenCountryCode(country_code, vat_number) {
        var valid_vat = true;
        var valid_country = true;
        var country_code.trim().toUpperCase();
        var vat_number = vat_number.replace(/\s*/gi,"");
        switch (country_code) {     
          case "AT": valid_vat = ATVATCheckDigit (vat_number); break;        
          case "BE": valid_vat = BEVATCheckDigit (vat_number); break;          
          case "BG": valid_vat = BGVATCheckDigit (vat_number); break;             
          case "CY": valid_vat = CYVATCheckDigit (vat_number); break;          
          case "CZ": valid_vat = CZVATCheckDigit (vat_number); break;      
          case "DE": valid_vat = DEVATCheckDigit (vat_number); break;       
          case "DK": valid_vat = DKVATCheckDigit (vat_number); break;                 
          case "EE": valid_vat = EEVATCheckDigit (vat_number); break;              
          case "ES": valid_vat = ESVATCheckDigit (vat_number); break;       
          case "EU": valid_vat = EUVATCheckDigit (vat_number); break;       
          case "FI": valid_vat = FIVATCheckDigit (vat_number); break;        
          case "FR": valid_vat = FRVATCheckDigit (vat_number); break;         
          case "GF": valid_vat = FRVATCheckDigit (vat_number); break;         
          case "PF": valid_vat = FRVATCheckDigit (vat_number); break;         
          case "TF": valid_vat = FRVATCheckDigit (vat_number); break;         
          case "GB": valid_vat = UKVATCheckDigit (vat_number); break;                     
          case "GR": valid_vat = ELVATCheckDigit (vat_number); break;               
          case "HR": valid_vat = HRVATCheckDigit (vat_number); break;            
          case "HU": valid_vat = HUVATCheckDigit (vat_number); break;         
          case "IE": valid_vat = IEVATCheckDigit (vat_number); break;              
          case "IT": valid_vat = ITVATCheckDigit (vat_number); break;            
          case "LT": valid_vat = LTVATCheckDigit (vat_number); break;            
          case "LU": valid_vat = LUVATCheckDigit (vat_number); break;            
          case "LV": valid_vat = LVVATCheckDigit (vat_number); break;             
          case "MT": valid_vat = MTVATCheckDigit (vat_number); break;           
          case "NL": valid_vat = NLVATCheckDigit (vat_number); break;            
          case "PL": valid_vat = PLVATCheckDigit (vat_number); break;         
          case "PT": valid_vat = PTVATCheckDigit (vat_number); break;           
          case "RO": valid_vat = ROVATCheckDigit (vat_number); break;       
          case "SE": valid_vat = SEVATCheckDigit (vat_number); break;        
          case "SI": valid_vat = SIVATCheckDigit (vat_number); break;         
          case "SK": valid_vat = SKVATCheckDigit (vat_number); break;
          default: valid_country = false;
        }
        return { valid_country: valid_country, valid_vat: valid_vat };
}
